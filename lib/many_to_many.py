...
class Contract:
    ...
    def check_author(self, author):  # sourcery skip: raise-specific-error
        if not isinstance(author, Author):
            raise Exception
        self.author = author
    def check_book(self, book):  # sourcery skip: raise-specific-error
        if not isinstance(book, Book):
            raise Exception
        self.book = book
    def check_date(self, date):  # sourcery skip: raise-specific-error
        if not isinstance(date, str):
            raise Exception
        self.date = date
    def check_royalties(self, royalties):  # sourcery skip: raise-specific-error
